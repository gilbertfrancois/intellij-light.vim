...
" Last Updated: Wed May 19 10:39:54 2021
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi LspDiagnosticsDefaultError guifg=#ff0000 guibg=NONE gui=NONE cterm=NONE
  hi LspDiagnosticsDefaultWarning guifg=#ffff00 guibg=NONE gui=NONE cterm=NONE
  hi LspDiagnosticsDefaultInformation guifg=#0000ff guibg=NONE gui=NONE cterm=NONE
  hi LspDiagnosticsDefaultHint guifg=#00ff00 guibg=NONE gui=NONE cterm=NONE
  hi LspDiagnosticsUnderlineError guifg=#ff0000 guibg=NONE gui=undercurl cterm=underline
  hi LspDiagnosticsUnderlineWarning guifg=#ffff00 guibg=NONE gui=undercurl cterm=underline
  hi LspDiagnosticsUnderlineInformation guifg=#0000ff guibg=NONE gui=undercurl cterm=underline
  hi LspDiagnosticsUnderlineHint guifg=#00ff00 guibg=NONE gui=undercurl cterm=underline
...
if s:t_Co >= 256
  ...
  hi LspDiagnosticsDefaultError ctermfg=196 ctermbg=NONE cterm=NONE
  hi LspDiagnosticsDefaultWarning ctermfg=226 ctermbg=NONE cterm=NONE
  hi LspDiagnosticsDefaultInformation ctermfg=21 ctermbg=NONE cterm=NONE
  hi LspDiagnosticsDefaultHint ctermfg=46 ctermbg=NONE cterm=NONE
  hi LspDiagnosticsUnderlineError ctermfg=196 ctermbg=NONE cterm=underline
  hi LspDiagnosticsUnderlineWarning ctermfg=226 ctermbg=NONE cterm=underline
  hi LspDiagnosticsUnderlineInformation ctermfg=21 ctermbg=NONE cterm=underline
  hi LspDiagnosticsUnderlineHint ctermfg=46 ctermbg=NONE cterm=underline
...
if s:t_Co >= 8
  ...
  hi LspDiagnosticsDefaultError ctermfg=LightRed ctermbg=NONE cterm=NONE
  hi LspDiagnosticsDefaultWarning ctermfg=LightYellow ctermbg=NONE cterm=NONE
  hi LspDiagnosticsDefaultInformation ctermfg=LightBlue ctermbg=NONE cterm=NONE
  hi LspDiagnosticsDefaultHint ctermfg=LightGreen ctermbg=NONE cterm=NONE
  hi LspDiagnosticsUnderlineError ctermfg=LightRed ctermbg=NONE cterm=underline
  hi LspDiagnosticsUnderlineWarning ctermfg=LightYellow ctermbg=NONE cterm=underline
  hi LspDiagnosticsUnderlineInformation ctermfg=LightBlue ctermbg=NONE cterm=underline
  hi LspDiagnosticsUnderlineHint ctermfg=LightGreen ctermbg=NONE cterm=underline
